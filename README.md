...
* **Independent Variables:** Standardized (Z-scored) to eliminate scale differences. For example comparing raw GDP to years of schooling. This allows us to rank variables on the same scale.
* **Dependent Variable:** Left unstandardized (raw years) to ensure coefficients remain interpretable. For example 1-standard-deviation improvement in schooling yields X real-world years of life.
